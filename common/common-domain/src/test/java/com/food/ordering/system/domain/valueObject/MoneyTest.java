...
class MoneyTest {
    ...
    void testIsGreaterThan() {
        ...
        assertFalse(lowerAmount.isGreaterThan(lowerAmount)); // Equal amounts
    }
    ...
    void testSetScale() {
        ...
        // The constructor doesn't scale the input
        assertEquals(new BigDecimal("10.123"), amount.getAmount());
        
        // But operations like add do scale the result
        Money addResult = amount.add(new Money(new BigDecimal("0.005")));
        assertEquals(new BigDecimal("10.13"), addResult.getAmount()); // Tests rounding
    }
